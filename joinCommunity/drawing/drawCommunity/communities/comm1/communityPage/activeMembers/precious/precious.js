...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="precious.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("preciousValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('preciousValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("preciousValue");
    })

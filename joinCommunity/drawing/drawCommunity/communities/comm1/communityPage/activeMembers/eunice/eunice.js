...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="eunice.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("euniceValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('euniceValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("euniceValue");
    })

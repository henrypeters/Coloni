...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="jemima.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("jemimaValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('jemimaValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("jemimaValue");
    })

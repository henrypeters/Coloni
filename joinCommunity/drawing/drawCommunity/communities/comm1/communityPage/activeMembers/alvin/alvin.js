...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="alvin.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("alvinValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('alvinValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("alvinValue");
    })

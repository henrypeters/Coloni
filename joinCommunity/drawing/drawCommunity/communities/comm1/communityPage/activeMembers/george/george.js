...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="george.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("georgeValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('georgeValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("georgeValue");
    })

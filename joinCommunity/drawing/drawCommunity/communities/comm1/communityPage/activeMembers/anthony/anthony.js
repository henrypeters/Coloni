...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="anthony.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("anthonyValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('anthonyValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("anthonyValue");
    })

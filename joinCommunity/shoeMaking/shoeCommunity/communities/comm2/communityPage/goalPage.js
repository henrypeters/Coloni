...
let itemsArray = localStorage.getItem('com2Items') ? JSON.parse(localStorage.getItem('com2Items')) : [];
...
function add(){
    if (input.value.length > 0) {
        ...
        localStorage.setItem('com2Items', JSON.stringify(itemsArray));
...
function del(){
  localStorage.removeItem('com2Items');
  todoCont.innerHTML =  '';
  itemsArray = [];
  input.value = ''
}

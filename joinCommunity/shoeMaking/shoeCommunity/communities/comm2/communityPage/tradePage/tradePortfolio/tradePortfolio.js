...
cardDisplayPrice1.innerHTML = localStorage.getItem("2ndvalue1");
cardDisplayPrice2.innerHTML = localStorage.getItem("2ndvalue2");
cardDisplayPrice3.innerHTML = localStorage.getItem("2ndvalue3");
...
displayShare.innerHTML = localStorage.getItem("2ndshareValue");
displayPrice.innerHTML = localStorage.getItem("2ndvalue1");
input.value = localStorage.getItem("2ndinputValue")

input.addEventListener("keyup", function() {
    localStorage.setItem('2ndvalue1', functionForPrice(Number.parseInt(input.value, 10)));
    localStorage.setItem('2ndshareValue', functionForShare(Number.parseInt(input.value, 10)));
    localStorage.setItem('2ndinputValue', input.value);
...
sellShareBtn.addEventListener("click", function() {
    ...
    localStorage.removeItem('2ndshareValue');
    localStorage.removeItem('2ndvalue1');
    localStorage.removeItem('2ndinputValue');
    input.value = ""
    }else{
        alert(`You have $0`)
    }
...
displayShare2.innerHTML = localStorage.getItem("2ndshareValue2");
displayPrice2.innerHTML = localStorage.getItem("2ndvalue2");
input2.value = localStorage.getItem("2ndinputValue2")

input2.addEventListener("keyup", function() {
    localStorage.setItem('2ndvalue2', functionForPrice2(Number.parseInt(input2.value, 10)));
    localStorage.setItem('2ndshareValue2', functionForShare2(Number.parseInt(input2.value, 10)));
    localStorage.setItem('2ndinputValue2', input2.value);
...
sellShareBtn2.addEventListener("click", function() {
    ...
    // localStorage.clear()
    localStorage.removeItem('2ndshareValue2');
    localStorage.removeItem('2ndvalue2');
    localStorage.removeItem('2ndinputValue2');
    input2.value = ""
    }else{
        alert(`You have $0`)
    }
...
displayShare3.innerHTML = localStorage.getItem("2ndshareValue3");
displayPrice3.innerHTML = localStorage.getItem("2ndvalue3");
input3.value = localStorage.getItem("2ndinputValue3")

input3.addEventListener("keyup", function() {
    localStorage.setItem('2ndvalue3', functionForPrice3(Number.parseInt(input3.value, 10)));
    localStorage.setItem('2ndshareValue3', functionForShare3(Number.parseInt(input3.value, 10)));
    localStorage.setItem('2ndinputValue3', input3.value);
...
sellShareBtn3.addEventListener("click", function() {
    ...
    // localStorage.clear()
    localStorage.removeItem('2ndshareValue3');
    localStorage.removeItem('2ndvalue3');
    localStorage.removeItem('2ndinputValue3');
    input3.value = ""
    }else{
        alert(`You have $0`)
    }

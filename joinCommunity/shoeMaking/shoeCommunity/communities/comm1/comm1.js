...
membersBtn.addEventListener("click", function() {
    ...
    let img1 = `../../../../../images/male/man5.webp`;
    let img2 = `../../../../../images/male/man4.avif`;
    let img3 = `../../../../../images/female/woman9.avif`;
    let img4 = `../../../../../images/female/woman6.webp`;
    let img5 = `../../../../../images/female/woman5.jpg`;
    let img6 = `../../../../../images/male/man6.webp`;
    let img7 = `../../../../../images/male/man3.avif`;
    let img8 = `../../../../../images/female/woman1.avif`;
    let name1 = `Richard`
    let name2 = `James`
    let name3 = `Erica`
    let name4 = `Elizabeth`

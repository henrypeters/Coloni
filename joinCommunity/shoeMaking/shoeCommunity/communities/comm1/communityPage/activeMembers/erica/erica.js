...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="erica.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("ericaValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('ericaValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("ericaValue");
    })

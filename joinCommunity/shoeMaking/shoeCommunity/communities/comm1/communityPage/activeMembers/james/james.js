...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="james.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("jamesValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('jamesValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("jamesValue");
    })

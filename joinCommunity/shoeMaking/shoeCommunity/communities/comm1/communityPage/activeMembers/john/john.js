...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="john.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("johnValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('johnValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("johnValue");
    })

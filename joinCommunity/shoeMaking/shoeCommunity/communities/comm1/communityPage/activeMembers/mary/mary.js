...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="mary.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("maryValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('maryValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("maryValue");
    })

...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="richard.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
function forView() {
    ...
    sectionForComment.innerHTML = `<h1>Comments</h1>
                                    ...
                                    <div class="cardHolder">
                                        ...
                                        <div class="card">
                                            <p>
                                            This is really amazing. Kinda breaking a record in the industry, but haven't finalized yet.
                                        ...
                                        <div class="card">
                                            <p>
                                            I strongly believe that we all in the shoe manufacturing 👢 industry can do more than that, you konw, 
                                            creating cool things for the public
                                            </p>
                                            <div class="writer">anonymous</div>
                                        </div>
                                        ...
                                        <div class="card">
                                            <p>
                                            Shoe manufacturing is thaaa best!!!!!!!!!!!💯💯💯
                                            </p>
                                            <div class="writer">anonymous</div>
                                        </div>
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("richardValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('richardValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("richardValue");
    })

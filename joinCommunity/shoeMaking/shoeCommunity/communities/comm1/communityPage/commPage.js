...
secondEvent.addEventListener("click", function() {
    ...
    eventCard2.innerHTML = `<h3 class="upcomingTitle">  Upcoming Event  </h3><hr class="lin">
                            <p class="eventName">Castle Tour</p>

                            <div>
                                <p class="eventAbout">About</p>
                                <p class="description">Castle Tour is a shoe festival that is commited in
                                                        teaching concepts and trading products in the shoe industry from 
                                                        diferent countries in the world.</p>
                            </div>

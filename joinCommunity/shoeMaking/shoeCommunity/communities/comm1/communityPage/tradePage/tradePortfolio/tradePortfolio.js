...
cardDisplayPrice1.innerHTML = localStorage.getItem("1stvalue1");
cardDisplayPrice2.innerHTML = localStorage.getItem("1stvalue2");
cardDisplayPrice3.innerHTML = localStorage.getItem("1stvalue3");
...
displayShare.innerHTML = localStorage.getItem("1stshareValue");
displayPrice.innerHTML = localStorage.getItem("1stvalue1");
input.value = localStorage.getItem("1stinputValue")

input.addEventListener("keyup", function() {
    localStorage.setItem('1stvalue1', functionForPrice(Number.parseInt(input.value, 10)));
    localStorage.setItem('1stshareValue', functionForShare(Number.parseInt(input.value, 10)));
    localStorage.setItem('1stinputValue', input.value);
...
sellShareBtn.addEventListener("click", function() {
    ...
    localStorage.removeItem('1stshareValue');
    localStorage.removeItem('1stvalue1');
    localStorage.removeItem('1stinputValue');
    input.value = ""
    }else{
        alert(`You have $0`)
    }
...
displayShare2.innerHTML = localStorage.getItem("1stshareValue2");
displayPrice2.innerHTML = localStorage.getItem("1stvalue2");
input2.value = localStorage.getItem("1stinputValue2")

input2.addEventListener("keyup", function() {
    localStorage.setItem('1stvalue2', functionForPrice2(Number.parseInt(input2.value, 10)));
    localStorage.setItem('1stshareValue2', functionForShare2(Number.parseInt(input2.value, 10)));
    localStorage.setItem('1stinputValue2', input2.value);
...
sellShareBtn2.addEventListener("click", function() {
    ...
    // localStorage.clear()
    localStorage.removeItem('1stshareValue2');
    localStorage.removeItem('1stvalue2');
    localStorage.removeItem('1stinputValue2');
    input2.value = ""
    }else{
        alert(`You have $0`)
    }
...
displayShare3.innerHTML = localStorage.getItem("1stshareValue3");
displayPrice3.innerHTML = localStorage.getItem("1stvalue3");
input3.value = localStorage.getItem("1stinputValue3")

input3.addEventListener("keyup", function() {
    localStorage.setItem('1stvalue3', functionForPrice3(Number.parseInt(input3.value, 10)));
    localStorage.setItem('1stshareValue3', functionForShare3(Number.parseInt(input3.value, 10)));
    localStorage.setItem('1stinputValue3', input3.value);
...
sellShareBtn3.addEventListener("click", function() {
    ...
    // localStorage.clear()
    localStorage.removeItem('1stshareValue3');
    localStorage.removeItem('1stvalue3');
    localStorage.removeItem('1stinputValue3');
    input3.value = ""
    }else{
        alert(`You have $0`)
    }

...
let itemsArray = localStorage.getItem('com3Items') ? JSON.parse(localStorage.getItem('com3Items')) : [];
...
function add(){
    if (input.value.length > 0) {
        ...
        localStorage.setItem('com3Items', JSON.stringify(itemsArray));
...
function del(){
  localStorage.removeItem('com3Items');
  todoCont.innerHTML =  '';
  itemsArray = [];
  input.value = ''
}

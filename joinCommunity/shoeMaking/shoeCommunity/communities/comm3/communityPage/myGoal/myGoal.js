...
let itemsArrayMyGoal = localStorage.getItem('itemsMyGoal3') ? JSON.parse(localStorage.getItem('itemsMyGoal3')) : [];
...
function add(){
    if (input.value.length > 0) {
        ...
        localStorage.setItem('itemsMyGoal3', JSON.stringify(itemsArrayMyGoal));
...
function del(){
  localStorage.removeItem('itemsMyGoal3');
  todoCont.innerHTML =  '';
  itemsArrayMyGoal = [];
  input.value = ''
}

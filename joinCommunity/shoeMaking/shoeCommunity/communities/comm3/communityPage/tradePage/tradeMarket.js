...
function functionForPrice2(value) {
    ...
    input3.addEventListener("keyup", function() {
        ...
        displayShare3.innerHTML = localStorage.getItem("shareValue3");
        displayPrice3.innerHTML = localStorage.getItem("value3");
        input3.value = localStorage.getItem("inputValue3")
    })

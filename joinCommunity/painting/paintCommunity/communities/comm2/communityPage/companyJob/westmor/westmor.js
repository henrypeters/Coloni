...
acceptBtn.addEventListener("click", function() {
    ...
    let text = `<p class="amount">The amount to be paid is <i>$800</i></p>`;
    ...
    declineBtn.innerHTML = `<a href="westmor.html"><button> Back </button></a>`
    ...
    acceptBtn.addEventListener("click", function() {
        ...
        understandBtn.innerHTML = `<a href="../../commPage.html#compCard"><button> Get Started </button></a>`

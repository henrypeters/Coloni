...
cardDisplayPrice1.innerHTML = localStorage.getItem("paint1stvalue1");
cardDisplayPrice2.innerHTML = localStorage.getItem("paint1stvalue2");
cardDisplayPrice3.innerHTML = localStorage.getItem("paint1stvalue3");
...
displayShare.innerHTML = localStorage.getItem("paint1stshareValue");
displayPrice.innerHTML = localStorage.getItem("paint1stvalue1");
input.value = localStorage.getItem("paint1stinputValue")

input.addEventListener("keyup", function() {
    localStorage.setItem('paint1stvalue1', functionForPrice(Number.parseInt(input.value, 10)));
    localStorage.setItem('paint1stshareValue', functionForShare(Number.parseInt(input.value, 10)));
    localStorage.setItem('paint1stinputValue', input.value);
...
sellShareBtn.addEventListener("click", function() {
    ...
    localStorage.removeItem('paint1stshareValue');
    localStorage.removeItem('paint1stvalue1');
    localStorage.removeItem('paint1stinputValue');
    input.value = ""
    }else{
        alert(`You have $0`)
    }
...
displayShare2.innerHTML = localStorage.getItem("paint1stshareValue2");
displayPrice2.innerHTML = localStorage.getItem("paint1stvalue2");
input2.value = localStorage.getItem("paint1stinputValue2")

input2.addEventListener("keyup", function() {
    localStorage.setItem('paint1stvalue2', functionForPrice2(Number.parseInt(input2.value, 10)));
    localStorage.setItem('paint1stshareValue2', functionForShare2(Number.parseInt(input2.value, 10)));
    localStorage.setItem('paint1stinputValue2', input2.value);
...
sellShareBtn2.addEventListener("click", function() {
    ...
    // localStorage.clear()
    localStorage.removeItem('paint1stshareValue2');
    localStorage.removeItem('paint1stvalue2');
    localStorage.removeItem('paint1stinputValue2');
    input2.value = ""
    }else{
        alert(`You have $0`)
    }
...
displayShare3.innerHTML = localStorage.getItem("paint1stshareValue3");
displayPrice3.innerHTML = localStorage.getItem("paint1stvalue3");
input3.value = localStorage.getItem("paint1stinputValue3")

input3.addEventListener("keyup", function() {
    localStorage.setItem('paint1stvalue3', functionForPrice3(Number.parseInt(input3.value, 10)));
    localStorage.setItem('paint1stshareValue3', functionForShare3(Number.parseInt(input3.value, 10)));
    localStorage.setItem('paint1stinputValue3', input3.value);
...
sellShareBtn3.addEventListener("click", function() {
    ...
    // localStorage.clear()
    localStorage.removeItem('paint1stshareValue3');
    localStorage.removeItem('paint1stvalue3');
    localStorage.removeItem('paint1stinputValue3');
    input3.value = ""
    }else{
        alert(`You have $0`)
    }

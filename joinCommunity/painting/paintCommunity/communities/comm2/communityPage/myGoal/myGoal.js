...
let itemsArrayMyGoal = localStorage.getItem('paintItemsMyGoal2') ? JSON.parse(localStorage.getItem('paintItemsMyGoal2')) : [];
...
function add(){
    if (input.value.length > 0) {
        ...
        localStorage.setItem('paintItemsMyGoal2', JSON.stringify(itemsArrayMyGoal));
...
function del(){
  localStorage.removeItem('paintItemsMyGoal2');
  todoCont.innerHTML =  '';
  itemsArrayMyGoal = [];
  input.value = ''
}
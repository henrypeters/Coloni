...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="charity.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
function forView() {
    ...
    sectionForComment.innerHTML = `<h1>Comments</h1>
                                    ...
                                    <div class="cardHolder">
                                        ...
                                        <div class="card">
                                            <p>
                                            Really looks nice, maybe you can teach me some of your tricks in drawing.
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("charityValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('charityValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("charityValue");
    })

...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="praise.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("praiseValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('praiseValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("praiseValue");
    })

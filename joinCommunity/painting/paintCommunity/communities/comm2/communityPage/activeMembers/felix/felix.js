...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="felix.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("felixValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('felixValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("felixValue");
    })

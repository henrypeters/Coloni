...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="alex.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("alexValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('alexValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("alexValue");
    })

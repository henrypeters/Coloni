...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="jeremy.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("jeremyValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('jeremyValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("jeremyValue");
    })

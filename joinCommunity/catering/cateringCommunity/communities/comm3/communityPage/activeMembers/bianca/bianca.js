...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="kevin.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("kevinValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('kevinValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("kevinValue");
    })

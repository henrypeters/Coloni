...
let itemsArrayMyGoal = localStorage.getItem('foodItemsMyGoal3') ? JSON.parse(localStorage.getItem('foodItemsMyGoal3')) : [];
...
function add(){
    if (input.value.length > 0) {
        ...
        localStorage.setItem('foodItemsMyGoal3', JSON.stringify(itemsArrayMyGoal));
...
function del(){
  localStorage.removeItem('foodItemsMyGoal3');
  todoCont.innerHTML =  '';
  itemsArrayMyGoal = [];
  input.value = ''
}
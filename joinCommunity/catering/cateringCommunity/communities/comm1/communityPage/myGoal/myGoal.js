...
let itemsArrayMyGoal = localStorage.getItem('foodItemsMyGoal') ? JSON.parse(localStorage.getItem('foodItemsMyGoal')) : [];
...
function add(){
    if (input.value.length > 0) {
        ...
        localStorage.setItem('foodItemsMyGoal', JSON.stringify(itemsArrayMyGoal));

...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="philip.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
function forView() {
    ...
    sectionForComment.innerHTML = `<h1>Comments</h1>
                                    ...
                                    <div class="cardHolder">
                                        ...
                                        <div class="card">
                                            <p>
                                            This is really creative💯. More grace.
                                            </p>
                                            <div class="writer">anonymous</div>
                                        </div>
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("philipValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('philipValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("philipValue");
    })

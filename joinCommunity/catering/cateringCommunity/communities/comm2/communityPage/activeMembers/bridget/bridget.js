...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="cristine.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
function forView() {
    ...
    sectionForComment.innerHTML = `<h1>Comments</h1>
                                    ...
                                    <div class="cardHolder">
                                        ...
                                        <div class="card">
                                            <p>
                                            Really looks nice, maybe you can teach me some of your tricks in baking.
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("cristineValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('cristineValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("cristineValue");
    })

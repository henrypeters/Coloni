...
likeImg.addEventListener("click", function() {
    likeImg.innerHTML = `<a  href="joy.html"> <img src="../../../../../../../../images/icons/heart - Copy.png"> </a>`;
})
...
addComment.addEventListener("click", function() {
    ...
    pTagCard.innerHTML = localStorage.getItem("joyValue")

    commentInput.addEventListener("keyup", function() {
        localStorage.setItem('joyValue', commentInput.value);
        pTagCard.innerHTML = localStorage.getItem("joyValue");
    })

...
let itemsArrayMyGoal = localStorage.getItem('foodItemsMyGoal2') ? JSON.parse(localStorage.getItem('foodItemsMyGoal2')) : [];
...
function add(){
    if (input.value.length > 0) {
        ...
        localStorage.setItem('foodItemsMyGoal2', JSON.stringify(itemsArrayMyGoal));
...
function del(){
  localStorage.removeItem('foodItemsMyGoal2');
  todoCont.innerHTML =  '';
  itemsArrayMyGoal = [];
  input.value = ''
}